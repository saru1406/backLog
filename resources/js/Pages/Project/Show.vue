    ...
    <div class="flex w-full">
      ...
      <div class="flex flex-col w-3/5 sm:px-6 lg:px-8 py-12 ml-72">
        <div class="p-6 text-gray-900">
          <p class="font-semibold text-lg my-5">
            プロジェクトのホーム　: 　最近追加した課題一覧
          </p>
          <div
            class="bg-white overflow-hidden shadow-sm border border-gray-200 rounded"
          >
      ...
      <div class="flex flex-col w-2/5 sm:px-6 lg:px-8 py-12">
        <div class="p-6 text-gray-900">
          状態
          <div
            class="bg-white overflow-hidden shadow-sm border border-gray-200"
          >
