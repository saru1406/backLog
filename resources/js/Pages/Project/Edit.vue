    ...
    <div class="flex w-full">
      ...
      <div class="flex flex-col w-1/2 sm:px-6 lg:px-8 py-12 ml-72">
        ...
        <form @submit.prevent="store_project_user">
          ...
          >
            <option
              v-for="user in props.projectNotUsers"
              :key="user.id"
              :value="user.id"
            >
              {{ user.name }}
        ...
        <div class="p-6 text-gray-900">
          <p>参加ユーザー</p>
          <div
            class="bg-white overflow-hidden shadow-sm py-5 px-5 rounded-md border"
          >
            <table class="w-full">
              ...
              >
                <tr class="border-b border-gray-300 text-sm">
                  ...
                  <td
                    ...
                    @click="deleteUser(projectUser.id)"
      ...
      <div class="flex flex-col w-1/2 sm:px-6 lg:px-8 py-12">
        <div class="p-6 text-gray-900">
          ...
          >
            <table class="w-full">
              ...
              <tbody
                v-for="projectType in props.project.types"
                :key="projectType.id"
              >
                <tr class="border-b border-gray-300 text-sm">
                  ...
                  <td
                    style="cursor: pointer"
                    @click="deleteType(projectType.id)"
                    class="text-center font-semibold text-red-500"
                  >
                    x
                  </td>
        ...
        <div class="mt-10 self-end">
          <!-- mt-10は上部のコンテンツとの間隔を調整、self-endは要素をコンテナの右側に配置 -->
          <div
            @click="deleteProject"
